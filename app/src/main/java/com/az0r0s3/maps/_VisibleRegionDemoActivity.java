 ...
 */
public class _VisibleRegionDemoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final LatLng SOH = new LatLng(10.788966,106.770694);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(SOH,8));
        // Add a marker to the Opera House.
        mMap.addMarker(new MarkerOptions().position(SOH).title("Sydney Opera House"));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(SOH,16.0f));
